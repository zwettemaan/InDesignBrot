...
var document = UXES.G.app.documents.add();

//
// Give the user something to watch while it's happening.
//
UXES.G.app.scriptPreferences.enableRedraw = true;

document.viewPreferences.horizontalMeasurementUnits = UXES.G.MeasurementUnits.POINTS;
document.viewPreferences.verticalMeasurementUnits = UXES.G.MeasurementUnits.POINTS;
...
function calculateMandelbrot() {
            ...
            if (! swatch) {
                ...
                if (! swatch || ! swatch.isValid) {
                    ...
                    swatch = document.colors.add(
                        { 
                            name: swatchName, 
                            model: UXES.G.ColorModel.PROCESS, 
                            space: UXES.G.ColorSpace.RGB
                        }
                    );
    ...
    UXES.alert("Time elapsed:" + (endDate.getTime() - startDate.getTime()) / 1000.0);
